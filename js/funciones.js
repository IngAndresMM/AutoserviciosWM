...
export function mostrarMenu() {
    if(navegacion.classList.contains('desactivar')) {
        navegacion.classList.remove('desactivar');
        cerrarMenu.textContent = 'X';
    } else {
        navegacion.classList.add('desactivar');
        cerrarMenu.textContent = '';
    }
}
